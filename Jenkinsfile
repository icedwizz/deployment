        ...
        stage('Build-Release') {
         ...
         stage('Test-Release') {
             steps {
                ...
                //sh chmod +x -R ${env.WORKSPACE}"
                bat("${WORKSPACE}/Scripts/testRelease.ps1 -apiKey=tjO4XFM.YyIj1DidmcCRB72RMUISPtPLaoVD4IhE4Yx -inputFolder='Models' -serverBase=http://localhost:8088/semarchy -dataLocation='DemoTest' -modelName=DemoTest")
             }
	    }

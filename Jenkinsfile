    ...
    stages {
        ...
        stage('Build-Release') {
		 ...
		 //echo "${WORKSPACE}/Scripts/buildRelease.sh"
                 ...
                 bat("${WORKSPACE}Scripts/buildRelease.ps1 -apiKey=tjO4XFM.YyIj1DidmcCRB72RMUISPtPLaoVD4IhE4Yx -serverBase=http://localhost:8088/semarchy -modelName=DemoTest -devModelEdition=0.1 -r='Building release for DemoTest [0.1]'")
                 }
        }
